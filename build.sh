...
# Build Deb packages
make -j "$(getconf _NPROCESSORS_ONLN)" deb-pkg LOCALVERSION=-mbp-nosig KDEB_PKGVERSION="$(make kernelversion)-$(get_next_version mbp-alt)"
...
# # Build Deb packages
# make -j "$(getconf _NPROCESSORS_ONLN)" deb-pkg LOCALVERSION=-mbp-nosig-alt KDEB_PKGVERSION="$(make kernelversion)-$(get_next_version mbp)"
